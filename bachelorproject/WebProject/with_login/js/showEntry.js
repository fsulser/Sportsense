$(document).on('click', '#capturedEvents > tr', function() {
	...
	if(rowIndex != 0){
		$('#eventFrame').prepend('<div class="alert-warning info" style="padding:5px; margin-bottom:5px" id="eventInformation"><p>You are changing the <b>'+ rowIndex +'.</b> Event!<p></div>');
		$('.popup').remove();
		...
		$('#Events').val(Entries[rowIndex].GameEvent);
